...
$__System.register('1', ['3', '5', '6', '7', '8', '9', 'a', 'b', 'c'], function (_export) {
  // import angular
  ...
  return {
    setters: [function (_) {
      ...
      detalheconvidado = _3['default'];
    }, function (_4) {
      listaconvidado = _4['default'];
    }, function (_5) {
      convitesfesta = _5['default'];
    }, function (_6) {
      detalhefesta = _6['default'];
    }, function (_a) {
      listarfesta = _a['default'];
    }, function (_b) {
      serviceconvidado = _b['default'];
    }, function (_c) {
    ...
    execute: function () {
      ...
      });svc = [serviceconvidado, servicefesta];
